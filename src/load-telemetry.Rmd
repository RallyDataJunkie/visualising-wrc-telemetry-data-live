...
Let's clean it a little by removing reference to the Z dimension, capture the projection, and generate references to the route in both latlong and UTM forms:
...
We can then use the rounded first time as a basis for a running stage time estimate:
